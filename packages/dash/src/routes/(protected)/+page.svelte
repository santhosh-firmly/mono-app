		...
		<div class="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
			<Card.Root>
				<Card.Header class="pb-2">
					...
					<Card.Title class="text-3xl">${Object.values(data.wtd.results[0])[0]}</Card.Title>
				</Card.Header>
				<Card.Content>
			...
			<Card.Root>
				<Card.Header class="pb-2">
					...
					<Card.Title class="text-3xl">${Object.values(data.mtd.results[0])[0]}</Card.Title>
				</Card.Header>
				<Card.Content>
			...
			<Card.Root>
				<Card.Header class="pb-2">
					...
					<Card.Title class="text-3xl">${Object.values(data.ytd.results[0])[0]}</Card.Title>
				</Card.Header>
				<Card.Content>
					<div class="text-xs text-muted-foreground">+110% from last year</div>
				</Card.Content>
				<Card.Footer>
					<Progress value={12} aria-label="12% increase" />
				</Card.Footer>
				...
				<Card.Root>
					...
					<Card.Content>
						<Table.Root>
							...
							<Table.Body>
								{#each data.orders.results as order, index}
								<Table.Row class="${selectedOrderIndex === index ? 'bg-accent' : ''}">
									<Table.Cell>
									...
									<Table.Cell class="hidden sm:table-cell">{order.platform_order_number}</Table.Cell>
									<Table.Cell class="hidden md:table-cell">{order.created_dt}</Table.Cell>
									<Table.Cell class="text-right">${order.order_total}</Table.Cell>
								</Table.Row>
								{/each}
							</Table.Body>
						</Table.Root>
