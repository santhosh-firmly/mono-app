<script>
	// @ts-nocheck
	import { cartUpdateSku } from '$lib/browser/api-manager.js';
	import { debounce } from '$lib/browser/dash.js';
	import { ProductQuantity, ProductRemove } from '$lib/browser/localization.js';
...
<div class="text-xs py-1 text-secondary">
...
<button class="text-xs py-1 text-high cursor-pointer text-right" on:click={onRemove}>
	{ProductRemove}
</button>
