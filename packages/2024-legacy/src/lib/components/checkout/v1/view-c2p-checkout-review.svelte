<script>
	...
	import { InfoC2PNoCards, ReviewCVV, ReviewCVVToolTip } from '$lib/browser/localization.js';
	...
	import PaymentCvv from '$lib/components/payment/payment-cvv.svelte';
...
<ViewBaseReview id="viewC2PReview">
	<div slot="paymentSlot">
		...
		{#if firstPaymentId == null}
			<div class="py-2 text-xs font-semibold justify-start items-center">{InfoC2PNoCards}</div>
