...
<div class="flex items-center justify-center">
	...
	{:else}
		<button
			...
			type="submit"
			class="cursor-pointer bg-fy-action p-3 rounded-lg w-full shadow hover:shadow-lg relative flex flex-row items-center justify-center"
		...
		>
			{#if inProgress}
				<svg
					aria-hidden="true"
					class="w-6 h-6 animate-spin {isActionDark
