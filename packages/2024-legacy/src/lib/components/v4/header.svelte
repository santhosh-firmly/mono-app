...
<header class="w-full flex flex-col max-md:fixed top-0 z-[120] max-md:shadow-sm">
	{#if expanded}
		<button
			class="fixed top-0 left-0 w-screen h-screen backdrop-blur-2xl bg-black opacity-30 z-[-100]"
	...
	>
		...
		<div
			class="md:hidden text-fy-on-primary-subtle text-xs p-1 flex flex-row items-center justify-end h-full w-1/2"
		>
			<div
	...
	{#if expanded}
		<div
			...
			class="fixed left-0 top-0 w-screen z-[100] bg-fy-primary max-h-screen ov-gradient-y-primary flex flex-col"
