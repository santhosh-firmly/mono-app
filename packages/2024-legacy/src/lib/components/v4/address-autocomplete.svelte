...
<div class="relative z-[900] w-full flex justify-center">
	<div class="absolute top-1 px-3 w-full">
		<Group>
			<div class="p-2 col-span-2 w-full rounded shadow-lg">
				{#each predictions as prediction, index}
					<button
						type="button"
						class="p-1 text-sm w-full text-left rounded"
				...
				<button
					type="button"
					class="p-1 text-xs underline text-fy-on-surface-subtle w-full text-left rounded"
