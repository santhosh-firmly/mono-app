<script>
	...
	export let autoSubmitWhenPasting = true;
	export let autoSubmitWhenTyping = true;
	...
	<div class="flex flex-row gap-2 justify-center">
		...
		{#each Array(otpLength) as { }, index (index)}
			<input
				...
				{disabled}
				class="shadow-md border-1 {error
					? 'border-red-600'
					: 'border-gray-300'} rounded-lg w-10 h-11 text-center disabled:bg-gray-100"
				type="text"
