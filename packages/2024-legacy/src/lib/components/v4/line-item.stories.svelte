...
<Meta title="Checkout V4/Header/Line Item" component={LineItem} tags={['autodocs']} />
...
<Story
	...
	parameters={{
		msw: {
			handlers: [
				rest.get('*.jpeg', async (req, res, ctx) => {
...
<Story
	...
	args={{
		image:
			'https://media-resize.adoreme.com/resize/1360/bundle/10/4/104828/gallery/5jk0zod9o_cinthia-black/invalid.jpeg'
	}}
/>
<Story name="Skeleton">
	<div class="w-[400px]">
