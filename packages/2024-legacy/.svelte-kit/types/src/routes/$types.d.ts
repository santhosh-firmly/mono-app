...
type LayoutRouteId = RouteId | "/" | "/(dynamo)/mk" | "/(dynamo)/mk/cart-drawer" | "/(dynamo)/mk/checkout" | "/(dynamo)/mk/construction" | "/(dynamo)/mk/header" | "/(dynamo)/mk/thank-you/[slug]" | "/configurator" | "/configurator-content" | "/drawer" | "/embed" | "/mock" | "/single-page" | null
