<script>
	...
	import NavBottom from '$lib-v4/components/common/nav-bottom.svelte';
	import NoticesField from '$lib-v4/components/common/notices-field.svelte';
	import ApiAlert from '$lib-v4/components/common/api-alert.svelte';
	import { sApiProgressInfo } from '$lib-v4/browser/api-manager.js';
...
<div class="mr-auto ml-auto flex h-full max-w-lg flex-col" fobs id="viewCheckout">
