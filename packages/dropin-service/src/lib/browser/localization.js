...
export const InfoC2PRememberMeLong = 'Select to be remembered on your device and browser at participating stores for faster checkout. Not recommended for shared devices.';
...
export const InfoMerchantOtpDetail = 'Enter OTP to access your saved cards and complete the purchase in one click';
...
export const InfoC2PNeedToVerify = 'For added security to complete your oder, you need to be verified with your bank.';
export const InfoC2PVerificationOptions = 'Select how you want to verify:';
export const InfoC2PVerifyBankApp = (cardNumber) => `Verify this purchase in the bank app associated with card **** ${cardNumber}. Return to this page for order confirmation.`;
export const InfoC2PVerifyOTPDestination = (method) => `Enter the code sent to <strong>${method}</strong> to complete your order`;
...
export const ReviewCVVToolTip = "3 digits CVV from the back of your card (4 digits if it's an AmEx)";
...
// Order Placed
export const OrderPlacedNotes = 'You will receive an email with order confirmation from the merchant.';
...
export const OrderSummary = (count) => (count == 1 ? 'Order Summary (1 item)' : `Order Summary (${count} items)`);
...
export const vipBenefits = ['Welcome offer, Up to 50% Off', '6th set FREE', 'Member only access & sales', '$10 off every set', 'Skip or cancel anytime'];
