<script>
	...
	/**
	 * @typedef {Object} ShippingAddressListProps
	 * @property {Array<Address>} addresses - The list of saved addresses
	 * @property {boolean} disabled - Whether the list is disabled
	 * @property {Function} onAddNewAddress - Callback when "add new address" is clicked
	 * @property {Function} onSelect - Callback when an address is selected
	 * @property {Object} selectedAddress - The currently selected address
	 */
