<script module>
	...
	const { Story } = defineMeta({
		...
		argTypes: {
			connected: {
				control: 'boolean',
				description: 'Whether PayPal is connected/authorized'
			}
		},
		args: {
			connected: false
...
{#snippet mockPaypalButton()}
	<button
		class="flex h-12.5 w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-[#ffc439] hover:bg-[#f0b72f]"
...
{#snippet template(args)}
	<div class="w-96">
		<PaymentPaypal {...args} paypalButton={mockPaypalButton} />
	</div>
{/snippet}
