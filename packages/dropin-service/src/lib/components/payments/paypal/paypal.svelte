<script>
	 ...
	 * @type {PaypalProps}
	 */
	let { merchantId = null, clientId = '', label = 'pay', currency = 'USD', intent = 'authorize', integrationVersion = 'v3', onPaypalHandler = () => {}, class: className = '' } = $props();
...
<div id="paypal-button" class="flex justify-center basis-full {className}">
</div>
