...
<div
	class={[
		'flex h-6 w-fit items-center overflow-hidden rounded-lg transition-all duration-200',
		{
...
<style scoped lang="postcss">
	...
	button {
		@apply relative flex h-full w-8 cursor-pointer items-center justify-center text-xs transition-all duration-200 hover:bg-white/20 focus:bg-white/20;
	}
