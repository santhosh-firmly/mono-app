    ...
    args={{
        ...
        c2pMaskedCard: {
            ...
            digitalCardData: {
                ...
                artUri: 'https://sandbox.assets.vims.visa.com/vims/cardart/22af01f2bdf445e497895d502dd1f1ae_imageA@2x.png',
                artHeight: 210,
                artWidth: 334,
                pendingEvents: ['PENDING_CARDHOLDER_AUTHENTICATION', 'PENDING_CONSUMER_IDV', 'PENDING_CONSUMER_DEVICE_BINDING'],
